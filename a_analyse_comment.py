...
for dir_name in dir_names:
	...
	print scipy.stats.spearmanr(comments_TI, distinct_Users)
	print scipy.stats.mstats.spearmanr(comments_TI, distinct_Users,use_ties=False)
	print scipy.stats.stats.kendalltau(comments_TI, distinct_Users)	
